...
```
[chohyunjun@localhost shell_practice]$ nano hello.sh 
[chohyunjun@localhost shell_practice]$ ls -l hello.sh 
-rw-r--r--. 1 chohyunjun chohyunjun 88 Jul 18 17:21 hello.sh
[chohyunjun@localhost shell_practice]$ cat hello.sh 
#!/bin/bash
...
```
./backup.sh 
Fri Jul 18 05:30:31 PM KST 2025
백업을 시작합니다
...
```
[chohyunjun@localhost new_project]$ nano quick_test.sh && \
chmod 777 quick_test.sh && \
cd quick_test.sh && \
echo "echo 'Hello World'"
bash: cd: quick_test.sh: Not a directory
[chohyunjun@localhost new_project]$ ./ quick_test.sh 
bash: ./: Is a directory
[chohyunjun@localhost new_project]$ pwd
/home/chohyunjun/quests/shell_practice/new_project
[chohyunjun@localhost new_project]$ ./quick_test.sh 
./quick_test.sh: line 1: echo 'Hello World': command not found
[chohyunjun@localhost new_project]$ ./ quick_test.sh 
bash: ./: Is a directory
[chohyunjun@localhost new_project]$ cat quick_test.sh 
"echo 'Hello World'"
```
...
ls -l test_script.sh 
-rwx------. 1 chohyunjun chohyunjun 0 Jul 18 17:44 test_script.sh
```
...
ls -l test_script.sh 
-rwxr-x---. 1 chohyunjun chohyunjun 0 Jul 18 17:44 test_script.sh
```
...
ls -l test_script.sh 
-rw-r-----. 1 chohyunjun chohyunjun 0 Jul 18 17:44 test_script.sh
```
\# 모든 사용자의 실행 권한 제거
...
./setup.sh 
설정완료
logs  quick_test.sh  setup.sh  test_script.sh  test.txt
```
...
dr-x------. 2 chohyunjun chohyunjun  6 Jul 18 18:07 project_logs
...
```
ls
logs  project_logs  quick_test.sh  setup.sh  test_script.sh  test.txt
[chohyunjun@localhost new_project]$ nano check_dir.sh
[chohyunjun@localhost new_project]$ cat check_dir.sh 
...
```
[chohyunjun@localhost project_logs]$ touch log.txt && \
echo `"로그 생성 완료"`
...
```
[chohyunjun@localhost new_project]$ chmod 100 check_dir.sh 
[chohyunjun@localhost new_project]$ ls -l check_dir.sh 
---x------. 1 chohyunjun chohyunjun 45 Jul 18 18:21 check_dir.sh
```
